        ...
        def do_GET(self):
                try:
                        if self.path.endswith("/hello"):
                                ...
                                output = ""
                                output += "<html><body><p style='color:blue; background-color:purple; margin-right:auto; margin-left:auto; font-size:72px; font-family: 'cursive;'>Hello!</p> <a href = '/index'>Back to home</a>"
                        ...
                        if self.path.endswith("/hola"):
                                ...
                                output = ""
                                output += "<html><body><p style='color:purple; background-color:blue; margin-right:auto; margin-left:auto; font-size:72px; font-family: 'cursive;'>&#161Hola!</p> <a href = '/index'>Back to home</a>"
                                output += "<form method='POST' enctype='multipart/form-data' action='/hello'><h2>What would you like to say?</h2><input name='message' type='text' ><input type='submit' value='Submit'> </form>"
                                output += "</body></html>"
                                self.wfile.write(output)
                                print output
